          ...
          <div className="rounded-md shadow-sm space-y-4">
            ...
            {role === 'Teacher' && (
               <>
                  ...
                  <div>
                     <input name="subjects" type="text" required className="appearance-none rounded-lg relative block w-full px-3 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="Subjects handling (e.g. Science, Mathematics)" value={subjects} onChange={(e) => setSubjects(e.target.value)} />
                  </div>
                  <div>
                     <input name="classes" type="text" required className="appearance-none rounded-lg relative block w-full px-3 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="Classes handling (e.g. Grade 6, Grade 7)" value={classes} onChange={(e) => setClasses(e.target.value)} />
                  </div>
               </>
            )}
            {role === 'Student' && (
               <div>
                  <input name="classes" type="text" required className="appearance-none rounded-lg relative block w-full px-3 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="Class/Grade Information (e.g. Grade 6)" value={classes} onChange={(e) => setClasses(e.target.value)} />
               </div>
            )}
            <div>
